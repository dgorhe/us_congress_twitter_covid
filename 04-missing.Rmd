...
congress <- read_csv("congress_tweets.csv", col_names = FALSE)
...
We did not encounter problem with the missing values, indeed, the problem was the opposite, too much data. We were lucky enough to find very high quality data online.
